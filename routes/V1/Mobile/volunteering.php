...
Route::prefix('mobile/volunteering/demand')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('mobile/volunteering/campaign/demand')->middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('cancel/{id}', [VolunteeringInCampaignController::class, 'destroy']); // wirte the function
});
