...
return new class extends Migration
{
    ...
    {
        Schema::create('sponsorship_document_updates', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained('users')->cascadeOnDelete();
            $table->foreignId('document_id')->constrained('Sponsorship_documents')->cascadeOnDelete();
            ...
            $table->enum('status',['انتظار', 'مقبول', 'مرفوض']);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('sponsorship_document_updates');
    }
};
